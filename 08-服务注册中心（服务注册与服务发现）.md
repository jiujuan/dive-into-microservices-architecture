...
在 client-server 客户端-服务端的通信请求模式中，客户端发送 HTTP 请求到服务端，完成一次 HTTP 服务请求。简单的 web 应用，开发也比较简单，完成服务端代码开发就可以完成这种 web 应用了。

<img width="468" height="175" alt="image" src="https://github.com/user-attachments/assets/71909f22-fc3f-411d-ad7e-01d4ae63b124" />
